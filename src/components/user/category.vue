...
<div>
    ...
    <div class="tool">
    	<router-link to="index"><el-button size="small">返回角色管理</el-button></router-link>
	...
	<el-dialog title="新增" :visible.sync="addDialog">
        <el-form  :model="handelAddCateRole" :rules="rules" ref="handelAddCateRole" label-width="100px">
            <el-form-item label="分类名称："  prop='c_name'>
                <el-input v-model="handelAddCateRole.c_name"  placeholder='请输入分类名称'></el-input>
            </el-form-item>
            <el-form-item label="描述："  prop='c_desc'>
                <el-input v-model="handelAddCateRole.c_desc"  placeholder='请输入分类描述'></el-input>
            </el-form-item>
	...
	<el-dialog title="编辑" :visible.sync="editDialog">
        <el-form  :model="handelEditCateRole" :rules="rules" ref="handelEditCateRole" label-width="100px">
            <el-form-item label="分类名称："  prop='e_name'>
                <el-input v-model="handelEditCateRole.e_name"  placeholder='请输入分类名称'></el-input>
            </el-form-item>
            <el-form-item label="描述："  prop='e_desc'>
                <el-input v-model="handelEditCateRole.e_desc"  placeholder='请输入分类描述'></el-input>
            </el-form-item>
            <el-form-item class='submitRight'>
